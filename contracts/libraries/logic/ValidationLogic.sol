...
library ValidationLogic {
    ...
    function validateBorrow(
        ...
        if (loanId != 0) {
            DataTypes.LoanData memory loanData = ILoanPool(loanAddress).getLoan(
                loanId
            );
        ...
        (vars.currentLtv, vars.currentLiquidationThreshold,vars.startIndex,vars.endIndex) = nftData
            .configuration
            .getCollateralParams();
        ...
        require(loanId >= vars.startIndex && loanId<=vars.endIndex,Errors.LOAN_ID_NOT_BE_ALLOWANCE);
    ...
    function validateAuction(
        ...
        require(
            ...
            loanData.state == DataTypes.LoanState.AvailableAuction ||
                loanData.state == DataTypes.LoanState.Active,
            Errors.LPL_INVALID_LOAN_STATE
        );
