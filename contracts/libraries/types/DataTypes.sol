...
library DataTypes {
    ...
    enum LoanState {
        ...
        Active,
        //The loan available in auction
        AvailableAuction,
        // The loan is in auction, highest price liquidator will got chance to claim it.
        Auction,
    ...
    struct LoanData {
        ...
        //bid prices
        uint256[] bidPrices;
        //Whether the position will be liquidated after repayment
        bool isLiquidate;
        //Rapay time list
        uint256 repayTime;
    }
