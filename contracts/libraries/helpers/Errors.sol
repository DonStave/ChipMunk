 ...
 * @author CHIPMUNK
 * @notice Defines the error messages emitted by the different contracts of the CHIPMUNK protocol
 */
library Errors {
    enum ReturnCode {
        SUCCESS,
    ...
    string public constant LP_AMOUNT_GREATER_THAN_MAX_REPAY = "415";
    string public constant LP_AMOUNT_LESS_THAN_MIN_LEND = "416";
    string public constant LOAN_ID_NOT_BE_ALLOWANCE = "417";
    ...
    string public constant CT_CALLER_MUST_BE_MANAGE = "504";
    ...
    string public constant RC_INVALID_AUCTION_DURATION = "735";
    string public constant RC_INVALID_MIN_BID_FINE = "736";
    string public constant RC_INVALID_MAX_BID_FINE = "737";
    ...
    //Paused
    string public constant DEPOSIT_PAUSED = "800";
    string public constant WITHDRAW_PAUSED = "801";
    string public constant BORROW_PAUSED = "802";
    string public constant CLAIM_REWARD = "803";
    string public constant REPAY_PAUSED = "804";
    string public constant AUCTION_PAUSED = "805";
    string public constant LIQUIDATE_PAUSED = "806";
    string public constant ORACLE_PAUSED = "807";
}
