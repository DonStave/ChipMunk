...
contract ProtocolProvider {
    ...
    )
    {
        ...
        (ltv, liquidationThreshold,startIndex,endIndex) = configuration
    ...
    {
        loanData.loanId = ILoanPool(ADDRESSES_PROVIDER.getLendPoolLoan())
    ...
    function _fillLoanData(
        ...
        (, loanData.currentAmount) = ILoanPool(
            ADDRESSES_PROVIDER.getLendPoolLoan()
