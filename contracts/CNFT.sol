    ...
    IERC1155ReceiverUpgradeable
{
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "CNFT: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "CNFT: new owner is the zero address");
    ...
    function mint(address to, uint256 tokenId) external override nonReentrant {
        ...
        if (!isCA) {
            require(to == _msgSender(), "CNFT: caller is not to");
        }
    ...
    function flashLoan(
        ...
        require(receiverAddress != address(0), "CNFT: zero address");
        require(nftTokenIds.length > 0, "CNFT: empty token list");
    ...
    function claimERC20Airdrop(
        ...
        require(
            ...
            "CNFT: token can not be underlying asset"
        );
        require(token != address(this), "CNFT: token can not be self address");
