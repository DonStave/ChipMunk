...
contract ReserveOracle is IReserveOracleGetter, Initializable, BlockContext {
    ...
    function removeAggregator(address _priceFeedKey) external onlyAdmin {
    ...
    modifier onlyAdmin() {
        require(msg.sender == admin, "ReserveOracle: !admin");
        _;
    }
