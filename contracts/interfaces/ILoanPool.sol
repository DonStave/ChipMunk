...
interface ILoanPool {
    ...
    event AddBlackList(address _nftContract, uint256 _tokenId);
    event RemoveBlackList(address _nftContract, uint256 _tokenId);
    ...
    function addBlackList(address _nftContract, uint256 _tokenId) external;
    function removeBlackList(address _nftContract, uint256 _tokenId) external;
    function isBlackList(address _nftContract, uint256 _tokenId) external returns (bool);
    function getBlackList(address _nftContract) external view returns(uint256[] memory);
    ...
    function getBidderLoan(address bidder)
    external
    view
    returns (uint256[] memory loadIds);
